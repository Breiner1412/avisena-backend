...
from app.router import users, sheds, lands, incidentes_genrales, incidentes_gallina, registro_sensores, categories, inventory, sensor_types, sensors
...
app.include_router(incidentes_gallina.router, prefix="/incidentes_gallina", tags=["incidentes_gallina"])
